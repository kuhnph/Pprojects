...
class params:
    def __init__(self):
        ...
        self.state0 = np.array([[0.0,-200.0,0.0,19.97123459712141,0.034651660315206535,1.0717219458321852,0.0067609086045195,0.053611856174029526,0.0,-0.001071723554406803,0.00013502286583893437,0.019970808132086952]]).T

        self.u_star = np.array([[-0.16535438223817353,0.8963873660509599,0.0019071678376488368,-0.0029077360373452846]]).T
